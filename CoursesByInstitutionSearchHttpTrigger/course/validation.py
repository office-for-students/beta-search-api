...
def check_query_parameters(
    countries, filters, institution, length_of_course, subjects, limit, max_default_limit, offset, language
):
...
class Validator:
    ...
    def validate(self):
        ...
        self.new_institution, i_error_objects = self.validate_institution()
